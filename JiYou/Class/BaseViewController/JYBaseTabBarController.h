...
@protocol JYBaseTabBarControllerDelegate <NSObject>
...
@interface JYBaseTabBarController : UITabBarController
...
@property (nonatomic, weak) id<JYBaseTabBarControllerDelegate>XMDelegate;
