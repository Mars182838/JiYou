...
@property (nonatomic, retain) UIImageView *snipImgView;
...
- (void)initView {
    ...
    self.overlayView.alpha = .9f;
    self.overlayView.backgroundColor = [UIColor colorWithHexString:@"0x2b2b2b"];
...
//    [self drawCircle];
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 60, kScreenWidth, 30)];
...
- (void)initControlBtn {
    ...
    UIView *customView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreenHeight - 60.0f, kScreenWidth, 60)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, 0, 100, 60)];
...
//        [self.delegate imageCropper:self didFinished:[self getSubImage]];
        ...
        [self.delegate imageCropper:self selectedSize:[self getSubImageRect] didFinished:self.originalImage];
...
//    UIGraphicsBeginImageContextWithOptions(self.cropFrame.size, YES, 0.0f);
//    CGContextRef ctx = UIGraphicsGetCurrentContext();
//    
//    [self.snipImgView.image drawAtPoint:CGPointZero];
//    
//    CGRect clippingEllipseRect = CGRectMake(0, 0, self.cropFrame.size.width, self.cropFrame.size.height);
...
//    
//    self.snipImgView.image = UIGraphicsGetImageFromCurrentImageContext();
//    self.snipImgView.backgroundColor = [UIColor clearColor];
...
-(void)drawCircle{
    ...
    CGPathAddEllipseInRect(solidPath, nil, CGRectMake(0, 0, self.ratioView.width, self.ratioView.height));
    solidLine.path = solidPath;
    CGPathRelease(solidPath);
    [self.ratioView.layer addSublayer:solidLine];
}
