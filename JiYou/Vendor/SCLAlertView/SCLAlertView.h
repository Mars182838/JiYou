...
//buttons & textfields
@property (nonatomic, strong) SCLButton* cancelButton; //取消按钮
@property (nonatomic, strong) SCLButton* confirmButton; //确认按钮
@property (nonatomic, assign) BOOL buttonsHorizontal; //按钮是否水平排列, 默认是垂直排列

@property (nonatomic, copy) NSString* bankBrief; //银行名称简写, 用来找对应icon
