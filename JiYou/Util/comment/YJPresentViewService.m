...
SYNTHESIZE_ARC_SINGLETON_FOR_CLASS(YJPresentViewService)
...
- (void)presentViewController:(UIViewController *)controller completion:(void (^)(void))completion dismiss:(void (^)(void))dismiss
{
     ...
     *  pop动画弹出
     */
    if ([[NSUserDefaults standardUserDefaults] objectForKey:JYLoginUserName]) {
        ...
        _rootWindow.rootViewController = controller;
